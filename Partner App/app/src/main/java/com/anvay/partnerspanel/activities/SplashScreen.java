...
public class SplashScreen extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
            ...
            public void onSuccess(android.location.Location location) {
                if (location != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(getApplicationContext(), "address" + addressStr, Toast.LENGTH_SHORT).show();
    ...
    public void onConnectionSuspended(int i) {
        ...
        Toast.makeText(this, "connection suspended integer" + i, Toast.LENGTH_LONG).show();
        mGoogleApiClient.connect();
    }
